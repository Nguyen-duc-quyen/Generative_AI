"""
    The training process of the sparse autoencoder is slightly different from that of traditional autoencoders, thus the training code also need to be customized
"""
import torch
...
def train_one_epoch(model, dataloader, optimizer, loss_func, metrics, device):
    ...
    for i, data in tqdm(enumerate(dataloader)):
        ...
        loss = loss_func(output, target, embedding)
